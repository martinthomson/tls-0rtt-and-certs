...
This is the working area for the Individual internet-draft, "Cipher Suites for Negotiating Zero Round Trip (0-RTT) Transport Layer Security (TLS) with Renewed Certificate Authentication".

* [Editor's copy](https://martinthomson.github.io/tls-0rtt-and-certs/)
* [Individual Draft] (https://tools.ietf.org/html/draft-thomson-tls-0rtt-and-certs)
